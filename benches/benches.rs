...
// This is a helper function to remove boilerplate code from all the perft_* _chessbenchmarks
...
fn shakmaty_perft(bench: &mut Bencher, fen: String, depth: u64, count: u64) {
    ...
    bench.iter(|| assert_eq!(perft(&pos, depth as u8), count));
}
